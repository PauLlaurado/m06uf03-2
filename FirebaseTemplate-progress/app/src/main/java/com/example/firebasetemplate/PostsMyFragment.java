...
DocumentReference documentReference=db.collection("posts").document(FirebaseAuth.getInstance().getUid());
...
//                    System.out.println(getImages.get(0)+"asd");
//                }
//            }
...
//                            int imagefirebase = -item.hashCode();
//                            getImages.add(imagefirebase);
//                            System.out.println(getImages.get(0)+"sad");
//
//                        }
//                    }
//                })
...
documentReference.addSnapshotListener((Activity) getContext(), new EventListener<DocumentSnapshot>() {
    ...
    public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
        System.out.println(value.getString("authorName"));
        System.out.println(value.getString("content"));
    }
});


        adapter=new AdapterImages(getImages,FirebaseAuth.getInstance().getCurrentUser().getDisplayName(), "contenido");
